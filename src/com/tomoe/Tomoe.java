...
public class Tomoe extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
    	...
    	case R.id.imageStatus:
    		...
    		{
    			link="http://81.56.16.35/yana-server/plugins/detect_porte/stop_detect_porte.php";	
    			  //on charge la page
	  ...
	  //on charge la page
	    ...
	    case R.id.SaveOption:
	    	link="http://81.56.16.35/yana-server/plugins/detect_porte/detectporte.API.php?action=option";
        ...
        handler.postDelayed(new Runnable() { 
             public void run() { 
            	//on met à jour le statut de la détection
    	...
    	public ThreadConnection (String link, String action){
    	  ...
    	  public void run() {
    		  ...
    		  try {
    		    ...
    		    URL url = new URL ("http://81.56.16.35/yana-server/plugins/detect_porte/detectporte.API.php?action="+_link);
    		    ...
    		    while ((ligne = reader.readLine()) != null) {
    		    	...
    		    	if(ligne.equalsIgnoreCase("1") && _action.equals("updtOptions") ){
    		    		...
    		    		//affichage des checkbox en fonction de l'info qu'on récupère
